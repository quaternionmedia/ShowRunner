...
- **ShowScripter**: Script viewer (PDF, Fountain, etc.) with inline cue placement at `http://localhost:8000/script`
- **ShowDashboard**: Show selector and control dashboard at `http://localhost:8000/`
- **ShowAdmin**: Web-based database admin panel at `http://localhost:8000/admin` *(requires `admin` group)*
